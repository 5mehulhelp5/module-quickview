<?php
/**
 * Standalone install + heartbeat reporter for Panth_QuickView.
 *
...
namespace Panth\QuickView\Service;
...
{
    public const MAGENTO_MODULE = 'Panth_QuickView';
    public const COMPOSER_PACKAGE = 'mage2kishan/module-quickview';
