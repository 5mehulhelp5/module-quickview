<!-- SEO Meta -->
<!--
  Title: Magento 2 Quick View Extension with Product Compare & Recently Viewed | Hyva + Luma | Panth Infotech
  Description: Panth Quick View adds an AJAX product preview popup, product compare, recently viewed products, and an admin view-tracker report to Magento 2. Native Hyva (Alpine.js) and Luma templates. Works on Magento 2.4.4 to 2.4.8 and PHP 8.1 to 8.4. Built by Top Rated Plus Magento developer Kishan Savaliya.
  Keywords: magento 2 quick view, magento 2 quick view extension, magento 2 product preview popup, ajax quick view magento 2, hyva quick view, luma quick view, magento 2 product compare, magento 2 recently viewed products, magento 2 quick view modal, magento 2 most viewed products report
  Author: Kishan Savaliya (Panth Infotech)
  Canonical: https://kishansavaliya.com/magento-2-quickview.html
-->
...
[![Live Demo & Details](https://img.shields.io/badge/Live%20Demo%20%26%20Details-magento--2--quickview-0D9488?style=flat)](https://kishansavaliya.com/magento-2-quickview.html)
[![Packagist](https://img.shields.io/badge/Packagist-mage2kishan%2Fmodule--quickview-orange?logo=packagist&logoColor=white)](https://packagist.org/packages/mage2kishan/module-quickview)
...
- [View Tracker Report](#view-tracker-report)
- [FAQ](#faq)
- [Support](#support)
...
- **Saved per visitor** using the `panth_product_comparison` table, so the list survives page changes.
- **Add to compare from the quick view popup** with one click.

### Recently Viewed Products
- **Recently viewed block** for product, category, and CMS pages.
- **Per visitor history** stored in the `panth_recently_viewed` table.
- **Guests and logged in customers** are both tracked, guests by session.
...
1. A **Quick View** button is added to each product card through layout XML.
2. On click, an Alpine.js handler (Hyva) or RequireJS handler (Luma) sends an AJAX request to the Quick View controller.
3. The controller returns a rendered block with the image gallery, price, short description, SKU, stock status, and add to cart form.
4. The popup opens with a focus trap, body scroll lock, and close on ESC or click outside.
5. The open is recorded in the view tracker, and the product is saved to the visitor's recently viewed list.
6. The admin report reads this data so you can see the most previewed products.
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://kishansavaliya.com/magento-2-quickview.html">
    <img src="https://img.shields.io/badge/View%20Product%20Page-magento--2--quickview-0D9488?style=for-the-badge" alt="View Product Page" />
  </a>
</p>
...
<p align="center">
  <strong>Ready to give shoppers a faster way to browse?</strong><br/>
  <a href="https://kishansavaliya.com/magento-2-quickview.html">
    <img src="https://img.shields.io/badge/%F0%9F%9A%80%20See%20Quick%20View%20%E2%86%92-Product%20Page%20%26%20Demo-DC2626?style=for-the-badge" alt="See Quick View" />
  </a>
</p>
